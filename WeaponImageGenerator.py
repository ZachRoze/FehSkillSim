...
class WeaponImage:
    def __init__( self, weaponName, weaponType, weaponText, effAgainst ):
        ...
        self.might = mtRng[ 0 ]
        self.range = mtRng[ 1 ]
        self.outputFile = "NewWeaponImage.png"

        self.baseImage = Image.open( "static/FEHImages/FEHNewSkillTemplateEff.png" ) if self.effAgainst else Image.open( "static/FEHImages/FEHNewSkillTemplate.png" )
    ...
    def createImage( self ):
        ...
        self.baseImage.save( "static/NewWeapon.png" )
